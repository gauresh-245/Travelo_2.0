    ...
    <div className="flex flex-col justify-center px-4 sm:px-8 md:px-16 lg:mx-40 xl:mx-56 gap-6 sm:gap-8 md:gap-10">
      ...
      <Link to="/create-trip">
        <div className="flex justify-center">
          <button className="w-fit bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm sm:text-base px-4 py-2 sm:px-6 sm:py-3 rounded-full shadow-md hover:shadow-lg transition-all duration-300 ease-in-out">
